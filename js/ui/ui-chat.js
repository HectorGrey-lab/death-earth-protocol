window.UIChat = (function () {
  ...
  function render() {
    var html = messages.map(function (m) {
      ...
      return '<div class="chat-msg' + cls + '"><div class="chat-name">' + esc(m.username) + '</div><div class="chat-bubble"><div class="chat-text">' + esc(m.text) + '</div></div><div class="chat-time">' + time + '</div></div>';
    ...
    if (window.gameState) {
      ...
      if (window.gameState.ui.currentPage === 'chat') {
        ...
        if (chatMsgs) {
          ...
          div.innerHTML = '<div class="chat-name">' + esc(entry.username) + '</div><div class="chat-bubble"><div class="chat-text">' + esc(entry.text) + '</div></div><div class="chat-time">' + time + '</div>';
